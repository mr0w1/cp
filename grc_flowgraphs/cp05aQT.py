...
# Title: CP v0.5a QT
# Generated: Thu Jun 16 01:57:04 2016
##################################################
...
from am_chain import am_chain  # grc-generated hier_block
...
class cp05aQT(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "CP v0.5a QT")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("CP v0.5a QT")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "cp05aQT")
        ...
        self._ch3_modulation_options = (0, 1, 2, 3, )
        self._ch3_modulation_labels = ("DMR", "NBFM", "WBFM", "AM", )
        ...
        self._ch2_modulation_options = (0, 1, 2, 3, )
        self._ch2_modulation_labels = ("DMR", "NBFM", "WBFM", "AM", )
        ...
        self._ch1_modulation_options = (0, 1, 2, 3, )
        self._ch1_modulation_labels = ("DMR", "NBFM", "WBFM", "AM", )
        ...
        self.am_chain_0_0_0 = am_chain()
        self.am_chain_0_0 = am_chain()
        self.am_chain_0 = am_chain()

        ##################################################
        # Connections
        ##################################################
        self.connect((self.am_chain_0, 0), (self.blks2_selector_0_0, 3))    
        self.connect((self.am_chain_0_0, 0), (self.blks2_selector_0_0_0, 3))    
        self.connect((self.am_chain_0_0_0, 0), (self.blks2_selector_0_0_0_0, 3))    
        ...
        self.connect((self.blks2_selector_0, 3), (self.am_chain_0, 0))    
        ...
        self.connect((self.blks2_selector_0_1, 3), (self.am_chain_0_0, 0))    
        ...
        self.connect((self.blks2_selector_0_1_0, 3), (self.am_chain_0_0_0, 0))    
